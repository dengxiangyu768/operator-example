...
//+kubebuilder:rbac:groups=elasticweb.com.operator-example,resources=elasticwebs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=elasticweb.com.operator-example,resources=elasticwebs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=elasticweb.com.operator-example,resources=elasticwebs/finalizers,verbs=update
